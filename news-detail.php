...
<head>
    ...
    <link rel="canonical" href="https://twojadomena.pl/news-detail.php?slug=<?php echo htmlspecialchars($news['slug']); ?>">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link rel="stylesheet" href="css/style.css">

    <!-- Open Graph / Social Media -->
    <meta property="og:title" content="<?php echo htmlspecialchars($news['title']); ?>">
    <meta property="og:description" content="<?php echo htmlspecialchars($news['excerpt'] ?: substr(strip_tags($news['content']), 0, 160)); ?>">
    <meta property="og:type" content="article">
    <meta property="og:url" content="https://twojadomena.pl/news-detail.php?slug=<?php echo htmlspecialchars($news['slug']); ?>">
            ...
            <aside class="related-news">
                ...
                <div class="related-grid">
                    ...
                    <a href="news-detail.php?slug=<?php echo urlencode($item['slug']); ?>" class="related-card">
                        ...
                        <p><?php echo htmlspecialchars($item['excerpt'] ?: substr($item['content'], 0, 100) . '...'); ?></p>
                    </a>
                    <?php endforeach; ?>
                </div>
            </aside>
