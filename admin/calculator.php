...
// Pobierz produkty widoczne
$stmt = $pdo->query("SELECT * FROM products WHERE is_visible = 1 ORDER BY name");
$visible_products = $stmt->fetchAll();

// Pobierz podzespoły z magazynu
$stmt = $pdo->query("SELECT * FROM products WHERE is_visible = 0 ORDER BY category, name");
$warehouse_items = $stmt->fetchAll();
                ...
                <div class="add-item-section">
                                ...
                                <select id="selectService">
                                    ...
                                    <?php foreach ($services as $service): ?>
                                        <option value="<?php echo $service['id']; ?>"
                                            ...
                                            <?php echo number_format($service['discount_price'] ?: $service['price'], 2); ?>
                                            zł
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                    ...
                    <div id="productTab" class="tab-content">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary" onclick="addProductItem('selectProduct', 'productQty')">
                                    <i class="fas fa-plus"></i> Dodaj
                                </button>
                            </div>
                        </div>
                    ...
                    <div id="warehouseTab" class="tab-content">
                        <div class="form-row">
                            <div class="form-group" style="flex: 2;">
                                <label>Wybierz podzespół</label>
                                <select id="selectWarehouse">
                                    <option value="">-- Wybierz z magazynu --</option>
                                    <?php foreach ($warehouse_items as $item): ?>
                            ...
                            <div class="form-group">
                                <label>Ilość</label>
                                <input type="number" id="warehouseQty" value="1" min="1" step="1">
                            </div>
                            <div class="form-group">
                                <button class="btn btn-primary"
                                    onclick="addProductItem('selectWarehouse', 'warehouseQty')">
                                    <i class="fas fa-plus"></i> Dodaj
                                </button>
                            </div>
                        </div>
