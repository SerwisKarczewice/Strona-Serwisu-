...
<head>
    ...
    <title><?php echo $invoice['invoice_type'] === 'faktura' ? 'Faktura VAT' : 'Paragon'; ?> <?php echo $invoice['invoice_number']; ?></title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="invoice-container">
        ...
        <!-- Footer -->
        <div class="footer">
            <p>Dokument wygenerowany automatycznie przez system TechService</p>
